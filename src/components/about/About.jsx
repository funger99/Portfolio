      ...
      <div className="grid-container-a">
        <div className="grid-item grid-item-1a">
          ...
          <p className="about-me-p">
            I’m a Mechatronic Systems Engineering new graduate from University
            of Western Ontario. I have experience building products with signal
            processing, image processing, and internet of things (IoT)
            applications. Currently, I am diving into web development. I love
            learning new things. Outside of my professional life, I like to
            cook, exercise, explore different coffee shops. When I’m feeling
            down, playing with my dog cheers me up.
          </p>
        </div>
